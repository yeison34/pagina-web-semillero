...
import imagenprueba from "../../../../img/proyectos/prueba/ciencias.jpg";
function Propuesta() {
  return (
    <>
      {/*Primer proyecto propuesta */}
      {/*
      <div class="container pt-5">
        <div class="row g-5">
          ...
          <div
            ...
            data-wow-delay=".5s">
            <h5 class="text-primary">Propuesta</h5>
            <h1 class="mb-4">
...
*/}
      {/*fin Primer proyecto propuesta */}

      {/*segundo proyecto propuesta */}
      {/*
        <div class="container pt-5">
          <div class="row g-5">
            <div
      ...
      */}
      {/*fin segundo proyecto propuesta */}
    </>
  );
}
